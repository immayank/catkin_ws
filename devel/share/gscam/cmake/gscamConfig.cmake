...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/mayank/catkin_ws/src/gscam)
  set(gscam_DEVEL_PREFIX /home/mayank/catkin_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/mayank/catkin_ws/install)
...
if(NOT "/home/mayank/catkin_ws/src/gscam/include" STREQUAL "")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/mayank/catkin_ws/src/gscam/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mayank/catkin_ws/src/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
