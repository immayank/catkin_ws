...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'libfovis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mayank/catkin_ws/install/${idir}'.  Ask the maintainer 'Pep Lluis Negre <pl.negre@uib.cat>' to fix it.")
    endif()
